        ...
        <Modal show={showModalStitching} maxWidth='6xl' onClose={handleCloseModalStitching}>
            <div className='flex flex-col bg-white dark:bg-gray-800'>
                ...
                <div className='py-2 flex justify-around'>
                    <button type="button" className="text-white bg-green-700 hover:bg-green-800 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-green-600 dark:hover:bg-green-700">
                        Xác nhận
                    </button>
                    <button type="button" className="text-white bg-red-700 hover:bg-red-800 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-red-600 dark:hover:bg-red-700" onClick={handleCloseModalStitching}>
                        Thoát
                    </button>
                </div>
            </div>
        ...
        <Modal show={showModalMachining} maxWidth='6xl' onClose={handleCloseModalMachining}>
            <div className='flex flex-col bg-white dark:bg-gray-800'>
                ...
                <div className='py-2 flex justify-around'>
                    ...
                    <button type="button" className="text-white bg-red-700 hover:bg-red-800 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-red-600 dark:hover:bg-red-700" onClick={handleCloseModalMachining}>
                        Thoát
                    </button>
                </div>
            </div>
