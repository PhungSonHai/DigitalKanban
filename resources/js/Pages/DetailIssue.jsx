        ...
        <div className='h-screen flex flex-col select-none'>
            ...
            <div className='flex flex-col flex-1'>
                <div className='flex flex-wrap gap-5 pt-8 px-5 justify-center items-center'>
                    ...
                    <div className=''>
                        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700" onClick={() => handleFillIssue()}>
                            Tìm kiếm
                        </button>
                    </div>
                </div>
