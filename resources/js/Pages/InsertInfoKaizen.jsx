...
function InsertInfoKaizen() {
    ...
    const [procressAt, setProcressAt] = useState("");
    ...
    const [befenit, setBefenit] = useState("");
    ...
    const handleAdd = function () {
        ...
        formData.append("benefit", befenit);
        ...
        formData.append("process_at", procressAt);
    ...
    return (
        <div>
            <React.Fragment>
                {isLoading && (
                    <div className="fixed inset-0 bg-gray-800/30 flex items-center justify-center backdrop-blur-sm z-20">
                        <div role="status">
                            <svg
                                aria-hidden="true"
