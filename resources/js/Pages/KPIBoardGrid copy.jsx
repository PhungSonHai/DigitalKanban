...
export default function KPIBoardGrid() {
    ...
    const [department2, setDepartment2] = useState("4001APL01");
    const [department3, setDepartment3] = useState("4001APL01");
    const [department4, setDepartment4] = useState("4001APL01");
            ...
            <div className="h-screen flex flex-col select-none zoom-70 xl:zoom-100">
                ...
                <div className="flex-1 bg-gray-100 grid grid-cols-2 grid-rows-2 gap-4 gap-y-4">
                    ...
                    <div className="col-span-1 row-span-1 w-full flex flex-col space-y-2 xl:space-y-5  border-2 border-red-400">
                        ...
                        <div className="flex flex-1 flex-col bg-gray-100">
                            <div className="pl-6 text-xl">Bảng 1 : Chuyền {department}</div>
                            <div className="flex flex-1">
                                <div className="w-3/12 xl:w-4/12 flex flex-1 flex-col p-5 justify-around gap-5">
                                    <div
                                        onClick={null}
